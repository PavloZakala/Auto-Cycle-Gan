...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.A_size = min(len(self.A_images), opt.max_dataset_size)  # get the size of dataset A
        self.B_size = min(len(self.B_images), opt.max_dataset_size)  # get the size of dataset B
